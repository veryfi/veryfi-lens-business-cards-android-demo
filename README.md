...
## Table of content
1. [Veryfi Lens Business Cards Android Demo](#example)
2. [Configuration](#configuration)
3. [Other platforms](#other_platforms)
4. [Get in contact with our team](#contact)

## Veryfi Lens Business Cards Android Examples <a name="example"></a>
You can find the demo project in this repository. You can also check the development documentation.
- [Lens for Business Cards](Documentation/AndroidLensBusinessCards.pdf)
